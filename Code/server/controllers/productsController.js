...
// Supports: ?search=&category=&minPrice=&maxPrice=&sort=
async function getAllProducts(req, res, next) {
  try {
    ...
    // Translate the ?sort= values into Mongoose sort
    // objects. Defaults to the newest-first if nothing or something
    // unrecognized is provided.
    const sortMap = {
      price_asc: { price: 1 },
      price_desc: { price: -1 },
      newest: { createdAt: -1 },
...
// below all functions require admin privileges
